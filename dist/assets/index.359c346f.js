(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function o(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerpolicy&&(n.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?n.credentials="include":e.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(e){if(e.ep)return;e.ep=!0;const n=o(e);fetch(e.href,n)}})();const p="/landingpage-new-year/assets/review-1.fb409a4f.jpg",d="/landingpage-new-year/assets/review-2.59fa329f.jpg",u="/landingpage-new-year/assets/review-3.0479a255.jpg",w="/landingpage-new-year/assets/review-4.75e180b8.jpg",g="/landingpage-new-year/assets/review-5.47a86831.jpg",f="/landingpage-new-year/assets/review-6.89321a4d.jpg",m="/landingpage-new-year/assets/review-7.ac6542d9.jpg",y=[p,d,u,w,g,f,m],v=y.map(t=>`
        ...
        `),e<0&&clearInterval(o)},1e3)})();const h=document.querySelectorAll("[video-controler]");h.forEach((t,s)=>{const o=t.closest(".video-wrapper"),r=o.querySelector(".play-icon"),e=o.querySelector(".arrow");o.onclick=function(){t.play(),t.setAttribute("controls","controls"),console.log("clicked"),r.style.display="none",e.style.display="none"}});
